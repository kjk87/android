...
-keep class com.pplus.prnumberuser.PRNumberApplication {
    <fields>;
    <methods>;
}
...
-keep class com.pplus.prnumberuser.core.database.entity.** {
    *;

}

-keep class com.pplus.prnumberuser.core.network.model.** {
    *;
}

-keep class com.pplus.prnumberuser.apps.pages.data.model.** {
        *;
}

-keep class com.pplus.prnumberuser.apps.location.data.** {
    *;
}

-keep class com.pplus.prnumberuser.apps.common.mgmt.** {
    *;
}

-keep class com.pplus.prnumberuser.core.code.** {
    *;
}
...
-keepclassmembers class com.pplus.prnumberuser.apps.signup.ui.VerificationMeStep2Fragment$AndroidBridge {
    public *;
}

-keepclassmembers class com.pplus.prnumberuser.apps.signup.ui.CashPGActivity$AndroidBridge {
    public *;
}

-keepclassmembers class com.pplus.prnumberuser.apps.common.ui.common.PGActivity$AndroidBridge {
    public *;
}

-keepclassmembers class com.pplus.prnumberuser.apps.event.ui.EventDetailActivity$AndroidBridge {
    public *;
}
