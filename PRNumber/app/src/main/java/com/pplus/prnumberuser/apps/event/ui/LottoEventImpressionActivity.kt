...
import com.pplus.prnumberuser.apps.event.data.LottoEventImpressionHeaderAdapter
...
import com.pplus.prnumberuser.databinding.ActivityEventImpressionBinding
...
class LottoEventImpressionActivity : BaseActivity(), ImplToolbar {
    ...
    override fun getPID(): String {
        return "Main_bolpoint_event_prizewinner review"
    }
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        mAdapter = LottoEventImpressionHeaderAdapter()
                ...
                if (response != null) {
                    if(response.data > 0){
                        ...
                        binding.textEventImpressionJoinMore.setOnClickListener {
                            ...
                            intent.putExtra(Const.LOTTO_TIMES, mLottoTimes)
                            intent.putExtra(Const.WIN_CODE, mAdapter!!.mEvent!!.winCode)
