package com.pplus.prnumberuser.apps.location.ui
...
import com.pplus.prnumberuser.apps.location.data.SearchLocationAdapter
...
import com.pplus.prnumberuser.core.util.PplusCommonUtil.Companion.hideKeyboard
import com.pplus.prnumberuser.databinding.ActivityLocationSetBinding
...
//        mMapView.setDaumMapApiKey(getString(R.string.kakao_app_key));
    ...
    private fun search() {
        ...
        ApiController.getMapApi().requestSearchLocationKeyword(mKeyword!!).enqueue(object : Callback<ResultDaumKeyword> {
