...
//import com.pplus.prnumberuser.apps.goods.data.BuyShippingHistoryAdapter
...
//import java.util.*
//
//class BuyShippingHistoryFragment : BaseFragment<BaseActivity>() {
//
...
//    private var mAdapter: BuyShippingHistoryAdapter? = null
...
//        mAdapter = BuyShippingHistoryAdapter()
...
//        })
//
//        mAdapter!!.setOnItemClickListener(object : BuyShippingHistoryAdapter.OnItemClickListener {
//
//            override fun onItemClick(position: Int) {
//
//                val intent = Intent(activity, BuyShippingDetailActivity::class.java)
...
//        @JvmStatic
//        fun newInstance() =
//                BuyShippingHistoryFragment().apply {
