...
import com.pplus.prnumberuser.apps.menu.ui.OrderPurchasePgActivity
import com.pplus.prnumberuser.apps.product.ui.PurchaseProductShipPgActivity
...
import com.pplus.prnumberuser.databinding.ItemCardSelectBinding
import java.util.*
...
//            listener?.onItemClick(holder.adapterPosition)
            ...
            holder.itemView.setOnClickListener {
                if(LoginInfoManager.getInstance().user.verification!!.media == "external"){
                    ...
                    }else if(holder.itemView.context as BaseActivity is OrderPurchasePgActivity){
                        (holder.itemView.context as OrderPurchasePgActivity).cardRegLauncher.launch(intent)
                    }
