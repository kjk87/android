...
import com.pplus.prnumberuser.apps.shippingsite.ui.ShippingSiteRegActivity
import com.pplus.prnumberuser.core.network.ApiBuilder
import com.pplus.prnumberuser.core.network.model.dto.ShippingSite
import com.pplus.prnumberuser.core.network.model.response.NewResultResponse
import com.pplus.prnumberuser.databinding.ItemShippingSiteBinding
...
class ShippingSiteAdapter : RecyclerView.Adapter<ShippingSiteAdapter.ViewHolder> {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.text_site_name.text = item.siteName
        ...
        holder.text_modify.setOnClickListener {
            ...
            if(holder.itemView.context is ShippingSiteConfigActivity){
                (holder.itemView.context as ShippingSiteConfigActivity).regLauncher.launch(intent)
            }
