//package com.pplus.prnumberuser.apps.group.data;
//
...
//import com.pplus.prnumberuser.apps.group.ui.GroupConfigActivity;
//import com.pplus.prnumberuser.apps.group.ui.GroupNameEditActivity;
...
//    }
//
//    public GroupConfigAdapter(Context context){
//
...
//                                        builder.addContents(new AlertData.MessageData(mContext.getString(R.string.format_msg_delete_group1, mContext.getString(R.string.word_fan)), AlertBuilder.MESSAGE_TYPE.TEXT, 3));
...
//                                                        ApiBuilder.create().deletePlusGroup(params).setCallback(new PplusCallback<NewResultResponse<Object>>(){
//
//                                                            @Override
...
//
//        ApiBuilder.create().updatePlusGroupPriorityAll(params).setCallback(new PplusCallback<NewResultResponse<Object>>(){
//
//            @Override
//            public void onResponse(Call<NewResultResponse<Object>> call, NewResultResponse<Object> response){
//
