...
import com.pplus.prnumberuser.databinding.ActivityPurchaseProductShippingHistoryDetailBinding
...
//                        text_purchase_product_shipping_history_detail_status.setText(R.string.word_shipping_ready)
                    ...
                    EnumData.DeliveryStatus.ING.status->{
                        ...
                        binding.textPurchaseProductShippingHistoryDetailStatus.setTextColor(ResourceUtil.getColor(this, R.color.color_579ffb))
...
//                text_purchase_product_shipping_history_detail_status.setText(R.string.word_shipping_complete)
        ...
        if (mPurchaseProduct!!.status != EnumData.PurchaseProductStatus.COMPLETE.status && mPurchaseProduct!!.savedPoint != null && mPurchaseProduct!!.savedPoint!! > 0) {
            ...
            if (mPurchaseProduct!!.isPaymentPoint != null && mPurchaseProduct!!.isPaymentPoint!!) {
                binding.textPurchaseProductShippingHistoryDetailPoint.text = getString(R.string.format_saved, FormatUtil.getMoneyType(mPurchaseProduct!!.savedPoint.toString()))
            } else {
                binding.textPurchaseProductShippingHistoryDetailPoint.text = getString(R.string.format_will_save, FormatUtil.getMoneyType(mPurchaseProduct!!.savedPoint.toString()))
            }
        } else {
