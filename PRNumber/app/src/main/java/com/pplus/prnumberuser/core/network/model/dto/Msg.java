...
public class Msg implements Parcelable{
    ...
    public String toString(){
        ...
        return "Msg{" + "no=" + no + ", type='" + type + '\'' + ", reserved=" + reserved + ", reserveDate='" + reserveDate + '\'' + ", completeDate='" + completeDate + '\'' + ", status='" + status + '\'' + ", subject='" + subject + '\'' + ", contents='" + contents + '\'' + ", moveType1='" + moveType1 + '\'' + ", moveType2='" + moveType2 + '\'' + ", moveTarget=" + moveTarget + ", moveTargetString='" + moveTargetString + '\'' + ", auth=" + auth + ", targetList=" + targetList + ", properties=" + properties + ", targetCount=" + targetCount + ", successCount=" + successCount + ", failCount=" + failCount + ", readCount=" + readCount + ", totalPrice=" + totalPrice + '}';
    }
