...
import com.pplus.prnumberuser.apps.product.data.ProductReviewHeaderAdapter
...
class StoreProductReviewFragment : BaseFragment<BaseActivity>() {
...
//            param2 = it.getString(ARG_PARAM2)
    ...
    private var mAdapter: ProductReviewHeaderAdapter? = null
...
//        }
        ...
        mAdapter = ProductReviewHeaderAdapter()
        ...
        mAdapter!!.setOnItemClickListener(object : ProductReviewHeaderAdapter.OnItemClickListener {
    ...
    private fun listCall(page: Int) {
        ...
        showProgress("")
        ApiBuilder.create().getProductReviewByPageSeqNo(params).setCallback(object : PplusCallback<NewResultResponse<SubResultResponse<ProductReview>>> {
    ...
    companion object {
        ...
        fun newInstance(page: Page) =
                StoreProductReviewFragment().apply {
