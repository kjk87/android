//package com.pplus.prnumberuser.core.contact;
//
...
//import com.pplus.prnumberuser.core.network.model.request.params.ParamsCustomerList;
...
//                        mContactDao.delete(new Contact(contactList.get(i).getMobileNumber(), contactList.get(i).getMemberName(), contactList.get(i).getDelete(), contactList.get(i).getUpdate()));
//                    }
//                }
//
