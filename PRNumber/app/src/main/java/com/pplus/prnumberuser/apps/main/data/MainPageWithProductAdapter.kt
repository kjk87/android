 ...
 */
class MainPageWithProductAdapter() : RecyclerView.Adapter<MainPageWithProductAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        adapter.setOnItemClickListener(object : MainTicketAdapter.OnItemClickListener {
...
//                    if (totalItemCount < item.totalGoodsElements!! && visibleItemCount + pastVisibleItems >= totalItemCount * Const.NEXT_RECYCLERVIEW_MARGIN) {
                    if (totalItemCount < item.totalProductPriceElements!! && visibleItemCount + pastVisibleItems >= totalItemCount) {
                        ...
                        ApiBuilder.create().getProductPriceListStoreTypeByPageSeqNoAndDiscountOnlyNormal(params).setCallback(object : PplusCallback<NewResultResponse<SubResultResponse<ProductPrice>>> {
