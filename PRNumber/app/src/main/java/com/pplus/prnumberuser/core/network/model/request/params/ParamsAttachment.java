...
import com.pplus.prnumberuser.core.util.imageresizer.ImageResizer;
...
public class ParamsAttachment extends BaseParams{
    ...
    public void buildFile(){
        ...
        tempFile = new File(PRNumberApplication.getContext().getCacheDir(), originFile.getName()+".png");
        ...
        try {
            ...
            LogUtil.e(LOG_TAG, "buildFile Exception {} ", e);
