...
//import com.pplus.prnumberuser.apps.main.data.AllFriendAdapter
...
//import java.util.*
//
//class AllFriendActivity : BaseActivity(), ImplToolbar {
...
//    }
//
//    private var mAdapter: AllFriendAdapter? = null
...
//        mAdapter = AllFriendAdapter(this)
//        recycler_user_friend.adapter = mAdapter
//        recycler_user_friend.addOnScrollListener(object : androidx.recyclerview.widget.RecyclerView.OnScrollListener() {
//
...
//
//        ApiBuilder.create().allFriendCount.setCallback(object : PplusCallback<NewResultResponse<Int>> {
//
...
//        showProgress("")
//        mLockListView = true
//        ApiBuilder.create().getAllFriendList(params).setCallback(object : PplusCallback<NewResultResponse<Friend>> {
//
