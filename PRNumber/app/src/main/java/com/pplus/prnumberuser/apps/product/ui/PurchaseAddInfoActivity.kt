...
import com.pplus.prnumberuser.core.network.model.dto.ProductAuth
import com.pplus.prnumberuser.core.network.model.dto.ProductInfo
import com.pplus.prnumberuser.core.network.model.dto.ProductPrice
import com.pplus.prnumberuser.core.network.model.response.NewResultResponse
import com.pplus.prnumberuser.databinding.ActivityPurchaseAddInfoBinding
...
class PurchaseAddInfoActivity : BaseActivity(), ImplToolbar {
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        if(mProductPrice!!.product!!.imageList != null && mProductPrice!!.product!!.imageList!!.isNotEmpty()){
            Glide.with(this).load(mProductPrice!!.product!!.imageList!![0].image).apply(RequestOptions().centerCrop().placeholder(R.drawable.prnumber_default_img).error(R.drawable.prnumber_default_img)).into(binding.imagePurchaseAddInfoProductImage)
        }
        ...
        when(mProductPrice!!.productDelivery!!.method){
            1->{
                binding.textPurchaseAddInfoDeliveryMethod.text = getString(R.string.word_delivery2)
            }
            2->{
