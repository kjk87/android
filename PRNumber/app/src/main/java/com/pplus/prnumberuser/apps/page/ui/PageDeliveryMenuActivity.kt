...
class PageDeliveryMenuActivity : BaseActivity() {
...
//                LogUtil.e(LOG_TAG, "y : {}", recyclerView.computeVerticalScrollOffset())
        ...
        binding.tabLayoutPageDeliveryMenu.setBottomBorder(resources.getDimensionPixelSize(R.dimen.height_0))
