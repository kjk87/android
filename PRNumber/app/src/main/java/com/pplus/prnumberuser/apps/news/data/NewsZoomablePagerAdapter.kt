...
class NewsZoomablePagerAdapter : PagerAdapter {

    private var mInflater: LayoutInflater
    private var dataList = ArrayList<NewsImage>()
    ...
    constructor(context: Context, dataList:ArrayList<NewsImage>) : super() {
    ...
    fun getData(position: Int): NewsImage {
