...
//
//class PlusFriendActivity : BaseActivity(), ImplToolbar {
...
//        pager_plus_friend.offscreenPageLimit = 4
...
//            internal set
//
//        private val titles = arrayOf(getString(R.string.word_plus), getString(R.string.word_my_friend_page))
//
//        init {
//            fragMap = SparseArray()
//        }
...
//            when (position) {
//                0 -> {
//                    return PlusFragment.newInstance()
//                }
//                else -> {
//                    return MainFriendFragment.newInstance()
//                }
//            }
//        }
//    }
...
//        toolbarOption.initializeDefaultToolbar(getString(R.string.word_phone_book), ToolbarOption.ToolbarMenu.LEFT)
