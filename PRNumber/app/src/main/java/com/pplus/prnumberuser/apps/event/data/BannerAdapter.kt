...
import com.pplus.prnumberuser.databinding.ItemBannerBinding
import java.util.*
...
class BannerAdapter : RecyclerView.Adapter<BannerAdapter.ViewHolder> {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(holder.itemView.context).load(item.image?.url).apply(RequestOptions().centerCrop().placeholder(R.drawable.prnumber_default_img).error(R.drawable.prnumber_default_img)).into(holder.image)
