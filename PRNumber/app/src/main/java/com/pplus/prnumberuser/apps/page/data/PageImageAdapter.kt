 ...
 */
class PageImageAdapter() : RecyclerView.Adapter<PageImageAdapter.ViewHolder>() {

    var mDataList: MutableList<PageImage>? = null
    ...
    fun getItem(position: Int): PageImage {

        return mDataList!![position]
    }

    fun getDataList(): MutableList<PageImage>? {

        return mDataList
    }

    fun add(data: PageImage) {
    ...
    fun addAll(dataList: List<PageImage>) {
    ...
    fun replaceData(position: Int, data: PageImage) {
    ...
    fun clear() {
        ...
        mDataList = ArrayList<PageImage>()
        notifyDataSetChanged()
    }

    fun setDataList(dataList: MutableList<PageImage>) {
