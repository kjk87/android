...
class StoreSubscriptionProductFragment : BaseFragment<BaseActivity>() {
...
//        showProgress("")
        ApiBuilder.create().getSubscriptionTypeByPageSeqNoOnlyNormal(params).setCallback(object : PplusCallback<NewResultResponse<SubResultResponse<ProductPrice>>> {
            ...
            override fun onResponse(call: Call<NewResultResponse<SubResultResponse<ProductPrice>>>?, response: NewResultResponse<SubResultResponse<ProductPrice>>?) {
                ...
                if (response != null) {
                    ...
                    if (response.data.first!!) {
                        ...
                        binding.textStoreSubscriptionProductCount.text = getString(R.string.format_subscription, FormatUtil.getMoneyType(mTotalCount.toString()))
                        mAdapter!!.clear()
                        if (mTotalCount == 0) {
...
//                hideProgress()
    ...
    companion object {
        ...
        fun newInstance(page:Page) =
                StoreSubscriptionProductFragment().apply {
