...
//            val imgView = v as ImageView?
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        Glide.with(binding.root.context).load(item).apply(RequestOptions().centerCrop().placeholder(R.drawable.prnumber_default_img).error(R.drawable.prnumber_default_img)).into(imageView)
...
//        }
        ...
        val image_delete = binding.imagePostWriteDelete
