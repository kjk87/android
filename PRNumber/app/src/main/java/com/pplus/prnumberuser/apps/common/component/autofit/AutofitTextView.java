package com.pplus.prnumberuser.apps.common.component.autofit;
...
public class AutofitTextView extends AppCompatTextView implements AutofitHelper.OnTextSizeChangeListener{
    ...
    public void setMaxTextSize(float size){
        ...
        mHelper.setMaxTextSize(TypedValue.COMPLEX_UNIT_DIP,size);
    }
    ...
    public void setMinTextSize(int minSize){
        ...
        mHelper.setMinTextSize(TypedValue.COMPLEX_UNIT_PX, minSize);
    }
