...
class ServicePageFragment : BaseFragment<BaseActivity>() {
...
//                PplusCommonUtil.goPage(activity!!, mAdapter!!.getItem(position), x, y)
    ...
    private fun listCall(page: Int) {
        ...
        ApiBuilder.create().getServicePageList(params).setCallback(object : PplusCallback<NewResultResponse<SubResultResponse<Page2>>> {
...
//            category = it.getParcelable(Const.DATA) //            param1 = it.getString(ARG_PARAM1)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() = ServicePageFragment().apply {
