 ...
 */
class MainSubscriptionAdapter: RecyclerView.Adapter<MainSubscriptionAdapter.ViewHolder>() {
    ...
    class ViewHolder(binding: ItemMainSubscriptionBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        init {
            ...
            (layout.layoutParams as RelativeLayout.LayoutParams).marginEnd = itemView.context.resources.getDimensionPixelSize(R.dimen.width_48)
