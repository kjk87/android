...
class ProductImagePagerAdapter : PagerAdapter {


    var dataList = ArrayList<ProductImage>()
        set(dataList) {
...
//        views.put(position, view)
        ...
        Glide.with(view.context).load(item.image).apply(RequestOptions().centerCrop().placeholder(R.drawable.prnumber_default_img).error(R.drawable.prnumber_default_img)).into(imageView)
