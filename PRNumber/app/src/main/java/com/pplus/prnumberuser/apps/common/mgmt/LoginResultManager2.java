...
import com.pplus.prnumberuser.core.code.common.RestrictionStatusCode;
...
public class LoginResultManager2{
    ...
    public void fail(final User user, final LoginResultListener listener){
        ...
        }).builder().show(PRNumberApplication.getContext(), true);
...
//            saveLogin(resultLogin);
    ...
    private String getString(int resId){
        ...
        return PRNumberApplication.getContext().getString(resId);
    }
