...
import com.pplus.prnumberuser.databinding.ItemContactBinding
...
class SelectContactAdapter : RecyclerView.Adapter<SelectContactAdapter.ViewHolder>() {
    ...
    class ViewHolder(binding: ItemContactBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        val text_contact_mobile = binding.textContactMobile
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.text_contact_mobile.text = FormatUtil.getPhoneNumber(item.mobileNumber)
