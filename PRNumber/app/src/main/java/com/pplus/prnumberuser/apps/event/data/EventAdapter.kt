...
import com.pplus.prnumberuser.databinding.ItemEventBinding
...
class EventAdapter : RecyclerView.Adapter<EventAdapter.ViewHolder> {
    ...
    constructor(context: Context, isPrEvent:Boolean) : super() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(mIsPrEvent){
            holder.layout.layoutParams.height = mContext!!.resources.getDimensionPixelSize(R.dimen.height_750)
        }
