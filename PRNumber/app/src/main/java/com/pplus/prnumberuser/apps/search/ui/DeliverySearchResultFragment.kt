...
import com.pplus.prnumberuser.apps.page.data.DeliveryPageAdapter
...
class DeliverySearchResultFragment : BaseFragment<BaseActivity>() {
    ...
    private var mAdapter: DeliveryPageAdapter? = null
    ...
    override fun init() {
        ...
        mAdapter!!.setOnItemClickListener(object : DeliveryPageAdapter.OnItemClickListener {
            override fun onItemClick(position: Int, view: View) {
                val intent = Intent(activity, PageDeliveryMenuActivity::class.java)
    ...
    private fun listCall(page: Int) {
        ...
        params["latitude"] = list[0].latitude.toString()
        params["longitude"] = list[0].longitude.toString()

        params["keyword"] = mSearchWord!!
        params["categoryMajorSeqNo"] = "8"
        params["page"] = page.toString()
        ApiBuilder.create().getDeliveryPageListByKeyword(params).setCallback(object : PplusCallback<NewResultResponse<SubResultResponse<Page2>>> {
    ...
    companion object {
        const val WORD = "word"
        fun newInstance(word: String?): DeliverySearchResultFragment {
            val fragment = DeliverySearchResultFragment()
            val args = Bundle()
