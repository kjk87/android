...
import com.pplus.prnumberuser.core.network.model.dto.LottoGift
import com.pplus.prnumberuser.core.util.PplusCommonUtil
import com.pplus.prnumberuser.databinding.HeaderLottoEventImpressionBinding
...
class LottoEventImpressionHeaderAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is ViewHeader) {
            ...
            holder.text_times.text = holder.itemView.context.getString(R.string.format_luckybol_lotto_event_title, mLottoTimes)
            holder.text_1st_gift_name.text = holder.itemView.context.getString(R.string.format_bol, FormatUtil.getMoneyType(item.lottoPrice.toString()))


            holder.text_1st_win_count.text = holder.itemView.context.getString(R.string.format_lotto_win_count, item.winnerCount.toString())
...
//                val intent = Intent(holder.itemView.context, AppMainActivity2::class.java)
                val intent = Intent(holder.itemView.context, LottoActivity::class.java)
