...
import com.pplus.prnumberuser.apps.menu.data.TicketPurchaseHistoryAdapter
...
class TicketPurchaseHistoryFragment : BaseFragment<BaseActivity>() {
    ...
    private var mAdapter: TicketPurchaseHistoryAdapter? = null
    ...
    override fun init() {
        ...
        mAdapter = TicketPurchaseHistoryAdapter()
        ...
        mAdapter!!.setOnItemClickListener(object : TicketPurchaseHistoryAdapter.OnItemClickListener {

            override fun onItemClick(position: Int) {
                val item = mAdapter!!.getItem(position)
                val intent = Intent(requireActivity(), TicketPurchaseHistoryDetailActivity::class.java)
    ...
    private fun listCall(page: Int) {
        ...
        showProgress("")
        ApiBuilder.create().getTicketPurchaseListByMemberSeqNo(params).setCallback(object : PplusCallback<NewResultResponse<SubResultResponse<OrderPurchase>>> {
...
//            param2 = it.getString(ARG_PARAM2)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
                TicketPurchaseHistoryFragment().apply {
