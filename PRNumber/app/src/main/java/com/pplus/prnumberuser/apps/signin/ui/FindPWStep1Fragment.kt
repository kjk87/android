...
import com.pplus.prnumberuser.databinding.FragmentFindPwStep1Binding
...
class FindPWStep1Fragment : BaseFragment<FindPWActivity>() {
    ...
    override fun init() {
        if (LoginInfoManager.getInstance().isMember) {
            ...
            binding.editFindPwMobileNumber.setText(user.mobile)
            getParentActivity().setLoginId(user.loginId!!)
