...
import com.pplus.prnumberuser.apps.shippingsite.data.SearchAddressAdapter
...
import com.pplus.prnumberuser.databinding.ActivitySearchAddressBinding
...
class SearchAddressActivity : BaseActivity(), ImplToolbar {
    ...
    private fun search(page: Int) {
        ...
        showProgress("")
        mLockListView = true
        ApiController.getPRNumberApi().requestSearchAddress(params).enqueue(object : Callback<ResultAddress> {
