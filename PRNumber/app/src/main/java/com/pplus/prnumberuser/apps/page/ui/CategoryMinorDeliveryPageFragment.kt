...
class CategoryMinorDeliveryPageFragment : BaseFragment<BaseActivity>() {
    ...
    private fun listCall(page: Int) {
        ...
        ApiBuilder.create().getDeliveryPageList(params).setCallback(object : PplusCallback<NewResultResponse<SubResultResponse<Page2>>> {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(category: CategoryMinor) = CategoryMinorDeliveryPageFragment().apply {
