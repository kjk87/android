...
import com.pplus.prnumberuser.apps.mobilegift.data.GiftishowAdapter
import com.pplus.prnumberuser.apps.mobilegift.data.MobileBrandAdapter
...
import com.pplus.prnumberuser.core.network.model.dto.MobileBrand
...
import com.pplus.prnumberuser.databinding.ActivityGiftishowBinding
        ...
        ApiBuilder.create().getMobileBrandList(params).setCallback(object : PplusCallback<NewResultResponse<MobileBrand>> {
            ...
            override fun onResponse(call: Call<NewResultResponse<MobileBrand>>?,
                ...
                if(response?.datas != null){
                    mMobileBrandAdapter!!.setDataList(response.datas)
    ...
    private fun setRetentionBol() {
        PplusCommonUtil.reloadSession(object : PplusCommonUtil.Companion.ReloadListener {
            override fun reload() {
                ...
                binding.textGiftishowRetentionPoint.text = PplusCommonUtil.fromHtml(getString(R.string.html_cash_unit, FormatUtil.getMoneyType(LoginInfoManager.getInstance().user.totalBol.toString())))
            }
        })
    }
