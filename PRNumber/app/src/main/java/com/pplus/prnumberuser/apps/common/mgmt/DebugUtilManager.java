...
import com.pplus.prnumberuser.core.debug.DebugManager;
...
public class DebugUtilManager{
    ...
    public static DebugUtilManager mDebugUtilManager;
    ...
    public class DebugValue implements Serializable{
...
/*
    public void loadDebugData(Context context){
        ...
        try {
            ...
            Cursor cursor = context.getContentResolver().query(PPLUS_URI, null, "debug_app_name = ?", new String[]{"com.pple.pplus"}, null);
...
/*
        try {
            ...
            context.getContentResolver().update(PPLUS_URI, values, "debug_app_name = ?", new String[]{"com.pple.pplus"});
        } catch (Exception e) {
...
*/
        ...
        DebugManager.with(getApplicationContext(), null).send(DebugConstant.SEND_TOKEN_DATA, bundle);
/*
