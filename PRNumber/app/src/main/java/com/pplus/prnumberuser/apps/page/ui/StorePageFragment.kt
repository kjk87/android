...
//import java.util.*
//
//class StorePageFragment : BaseFragment<BaseActivity>() {
//
...
////        }
//
////        image_page_list_address_view_map.setOnClickListener {
////            val intent = Intent(activity, LocationAroundPrActivity::class.java)
////            intent.flags = Intent.FLAG_ACTIVITY_CLEAR_TOP or Intent.FLAG_ACTIVITY_SINGLE_TOP
////            activity!!.startActivityForResult(intent, Const.REQ_LOCATION_CODE)
////        }
//        setData()
...
//                })
//            } else {
////                text_store_page_address.text = mLocationData!!.address
//            }
//            getCount()
//        }
//    }
...
//        params["type"] = PageTypeCode.store.name
