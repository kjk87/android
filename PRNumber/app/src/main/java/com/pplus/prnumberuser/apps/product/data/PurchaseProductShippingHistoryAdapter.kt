...
import com.pplus.prnumberuser.apps.product.ui.PurchaseProductShippingHistoryFragment
...
class PurchaseProductShippingHistoryAdapter() : RecyclerView.Adapter<PurchaseProductShippingHistoryAdapter.ViewHolder>() {
    ...
    var mFragment : PurchaseProductShippingHistoryFragment? = null
...
//                        intent.putExtra(Const.PRODUCT_PRICE, item.productPriceData)
                        ...
                        if(mFragment != null){
                            mFragment!!.launcher.launch(intent)
                        }else{
