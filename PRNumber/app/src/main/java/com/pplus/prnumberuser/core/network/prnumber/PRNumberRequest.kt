 ...
 */
class PRNumberRequest<T> protected constructor(builder: Builder<T>) {
     ...
     */
    class Builder<T> private constructor(): IPRNumberDefaultRequest<T> {
        /**
         * 실제 요청 콜 객체
         */
        ...
        companion object {
            @JvmStatic
            fun create(): IPRNumberDefaultRequest<*> {
                return Builder<Any?>()
            }
        }
    }
