...
//import com.pplus.prnumberuser.apps.goods.data.GoodsLikeShippingAdapter
...
//import java.util.*
//
//class GoodsLikeShippingFragment : BaseFragment<BaseActivity>() {
//
...
//    private var mAdapter: GoodsLikeShippingAdapter? = null
...
//        mAdapter = GoodsLikeShippingAdapter()
//        recycler_goods_like.adapter = mAdapter
//
//        (recycler_goods_like.layoutParams as RelativeLayout.LayoutParams).marginStart = resources.getDimensionPixelSize(R.dimen.width_38)
//        (recycler_goods_like.layoutParams as RelativeLayout.LayoutParams).marginEnd = resources.getDimensionPixelSize(R.dimen.width_38)
//        recycler_goods_like.addItemDecoration(CustomItemOffsetDecoration(activity!!, R.dimen.height_60))
...
//        })
//
//        mAdapter!!.setOnItemClickListener(object : GoodsLikeShippingAdapter.OnItemClickListener {
//
//            override fun onItemClick(position: Int) {
//
//                val intent = Intent(activity, GoodsDetailShipTypeActivity::class.java)
//                intent.putExtra(Const.DATA, mAdapter!!.getItem(position).goodsPrice)
//                activity!!.startActivityForResult(intent, Const.REQ_GOODS_DETAIL)
//            }
//        })
//
//        mAdapter!!.setOnItemDeleteListener(object : GoodsLikeShippingAdapter.OnItemDeleteListener {
...
//        @JvmStatic
//        fun newInstance() =
//                GoodsLikeShippingFragment().apply {
