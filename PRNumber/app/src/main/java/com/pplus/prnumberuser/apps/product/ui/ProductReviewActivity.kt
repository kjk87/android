...
import com.pplus.prnumberuser.apps.product.data.ProductReviewAdapter
...
import com.pplus.prnumberuser.databinding.ActivityGoodsReviewBinding
        ...
        return object : OnToolbarListener {
            override fun onClick(v: View?, toolbarMenu: ToolbarOption.ToolbarMenu?, tag: Any?) {
                when (toolbarMenu) {
                    ...
                    ToolbarOption.ToolbarMenu.RIGHT -> if (tag == 1) { //                    val intent = Intent(this, GoodsReviewWriteActivity::class.java)
