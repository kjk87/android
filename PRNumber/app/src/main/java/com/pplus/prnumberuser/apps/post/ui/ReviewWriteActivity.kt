...
//
//class ReviewWriteActivity : BaseActivity(), ImplToolbar {
...
//        pager_review_write_image.adapter = mImageAdapter
//        pager_review_write_image.offscreenPageLimit = 10
//
//        if (mPostMode == EnumData.MODE.UPDATE) {
//            mPost = intent.getParcelableExtra(Const.POST)
//            if (mPost != null) {
//                edit_review_write_contents.setText(mPost!!.contents)
//
//                if (mPost!!.attachList!!.size > 0) {
//                    layout_review_write_image.visibility = View.VISIBLE
//                }
//                mImageAdapter!!.attachedList = mPost!!.attachList as ArrayList<Attachment>
//            } else {
//                layout_review_write_image.visibility = View.GONE
//            }
//        }
//
//        layout_review_write_reg_photo.setOnClickListener {
//            goPostGallery()
//        }
//
//    }
...
//
//
//        val contents = edit_review_write_contents.text.toString()
//
...
//
//            runOnUiThread { this@ReviewWriteActivity.showProgress(message) }
//        }
//    }
//
//    /**
...
//
//        val contents = edit_review_write_contents.text.toString().trim()
//
//        if (StringUtils.isEmpty(contents)) {
//            ToastUtil.show(this, R.string.msg_input_review_contents)
//            return
...
//        params.type = EnumData.PostType.review.name
//
//        when (mPostMode) {
//
//            EnumData.MODE.WRITE -> {
//                if(mPage != null){
//                    params.board = No(mPage!!.reviewBoard!!.no)
//                }
//
...
//                    override fun onResponse(call: Call<NewResultResponse<Post>>, response: NewResultResponse<Post>) {
//
////                        for (url in mImageAdapter!!.dataList) {
////                            getFile(url).delete()
...
//                            }
//                        }
//                    }).builder().show(this@ReviewWriteActivity)
//                }
//            }
//        }
//    }
