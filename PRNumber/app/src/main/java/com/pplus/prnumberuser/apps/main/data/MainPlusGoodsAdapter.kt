...
//import kotlinx.android.synthetic.main.item_main_plus_goods.view.*
//import java.util.*
//
//
///**
...
// */
//class MainPlusGoodsAdapter : RecyclerView.Adapter<MainPlusGoodsAdapter.ViewHolder> {
//
...
//    }
//
//    fun setDataList(dataList: List<Goods>) {
//
//        this.mDataList = dataList as MutableList<Goods>
//        notifyDataSetChanged()
//    }
//
//    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
//
//        val image = itemView.image_main_plus_goods_image
//        val text_goods_name = itemView.text_main_plus_goods_goods_name
//        val text_discount_ratio = itemView.text_main_plus_goods_discount_ratio
//        val text_origin_price = itemView.text_main_plus_goods_origin_price
//        val text_sale_price = itemView.text_main_plus_goods_sale_price
//        val text_remain_count = itemView.text_main_plus_goods_remain_count
//        val text_point = itemView.text_main_plus_goods_point
//
//        init {
...
//        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_main_plus_goods, parent, false)
//        return ViewHolder(v)
//    }
//}