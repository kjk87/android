...
import com.pplus.prnumberuser.apps.product.data.PurchaseProductTicketHistoryAdapter
...
class PurchaseProductTicketHistoryFragment : BaseFragment<BaseActivity>() {
    ...
    private var mAdapter: PurchaseProductTicketHistoryAdapter? = null
    ...
    override fun init() {
        ...
        mAdapter = PurchaseProductTicketHistoryAdapter()
...
//        recycler_main_page.addItemDecoration(CustomItemOffsetDecoration(activity!!, R.dimen.height_60, R.dimen.height_60))
        ...
        mAdapter!!.setOnItemClickListener(object : PurchaseProductTicketHistoryAdapter.OnItemClickListener {

            override fun onItemClick(position: Int) {

                val intent = Intent(activity, PurchaseProductTicketHistoryDetailActivity::class.java)
    ...
    private fun listCall(page: Int) {
        ...
        showProgress("")
        ApiBuilder.create().getPurchaseProductListTicketTypeByMemberSeqNo(params).setCallback(object : PplusCallback<NewResultResponse<SubResultResponse<PurchaseProduct>>> {
...
//            param2 = it.getString(ARG_PARAM2)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
                PurchaseProductTicketHistoryFragment().apply {
