...
import com.pplus.prnumberuser.apps.prepayment.ui.PrepaymentDetailActivity
 ...
 */
class MainPageWithPrepaymentAdapter() : RecyclerView.Adapter<MainPageWithPrepaymentAdapter.ViewHolder>() {
...
//            PplusCommonUtil.goPage(holder.itemView.context, item, x, y)
        ...
        val adapter = MainPrepaymentAdapter()
        holder.recycler_product.layoutManager = layoutManager
        holder.recycler_product.adapter = adapter
        adapter.setDataList(item.prepaymentList!! as MutableList<Prepayment>)

        adapter.setOnItemClickListener(object : MainPrepaymentAdapter.OnItemClickListener {

            override fun onItemClick(position: Int, view: View) {
                val intent = Intent(holder.itemView.context, PrepaymentDetailActivity::class.java)
