...
//import com.pplus.prnumberuser.apps.event.ui.PRNumberEventActivity
//import com.pplus.prnumberuser.apps.event.ui.PlayActivity
//import com.pplus.prnumberuser.apps.mobilegift.ui.MobileGiftListFragment
...
//                    return
//                }
////                text_mobile_gift_retention_bol?.text = PplusCommonUtil.fromHtml(getString(R.string.html_cash_unit2, FormatUtil.getMoneyType(LoginInfoManager.getInstance().user.totalBol.toString())))
//            }
//        })
//    }
//
...
//        return "Main_mypage_nomoney_shopping"
//    }
//
//    companion object {
//
