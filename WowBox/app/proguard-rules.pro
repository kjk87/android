...
-keep class com.lejel.wowbox.WowBoxApplication {
    <fields>;
    <methods>;
}
...
# 모델들
-keep class com.lejel.wowbox.core.network.model.** {
    *;
}

-keep class com.lejel.wowbox.core.network.model.dto.** {
    *;
}

-keep class com.lejel.wowbox.apps.common.builder.data.** {
    *;
}

-keep class com.lejel.wowbox.core.network.model.response.** {
    *;
}

-keep class com.lejel.wowbox.apps.common.mgmt.** {
    *;
}
...
-keepclassmembers class com.lejel.wowbox.apps.common.ui.SearchAddressActivity$AndroidBridge {
    public *;
}
