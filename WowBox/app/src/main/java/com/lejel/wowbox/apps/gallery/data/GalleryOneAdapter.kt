...
import com.lejel.wowbox.databinding.ItemGalleryOneBinding
import java.util.*
...
class GalleryOneAdapter(private val context: Context) : RecyclerView.Adapter<GalleryOneAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(context).load(item.imageUri).apply(RequestOptions().centerCrop()).listener(object : RequestListener<Drawable> {
