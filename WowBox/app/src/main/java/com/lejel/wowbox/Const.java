...
//        public static String API_URL = "https://stg-api.wowboxapp.com/";
    public static String API_URL = "https://api.wowboxapp.com/";
//        public static final String CDN_URL = "https://stg-cdn.wowboxapp.com/";
    public static final String CDN_URL = "https://cdn.wowboxapp.com/";
    ...
    public static final String MOOBILE_NUMBER = "mobile_number";
    public static final String LOTTO_COUNT = "lotto_count";
    public static final String LOTTO_JOIN_TIME = "lotto_join_time";
    public static final String AD_MINING_TIME = "ad_mining";
    ...
    public static final String PLATFORM_EMAIL = "platformEmail";
    ...
    public static final String GOOGEL_REVIEW = "googel_review";
    ...
    public static String ADMOB_ID = "ca-app-pub-8921630185723546~3427380513";
    public static String ADMOB_INTERSTITIAL_ID = "ca-app-pub-8921630185723546/2222110054";
    public static String ADMOB_REWARDED_ID = "ca-app-pub-8921630185723546/3847032970";
}
