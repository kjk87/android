package com.lejel.wowbox.apps.inquire.ui
...
import com.lejel.wowbox.apps.gallery.ui.GalleryOnlyActivity
import com.lejel.wowbox.apps.inquire.data.InquireImageAdapter
...
import com.lejel.wowbox.core.network.upload.PplusUploadListener
import com.lejel.wowbox.core.network.upload.S3Upload
import com.lejel.wowbox.core.util.PplusCommonUtil
import com.lejel.wowbox.databinding.ActivityInquireBinding
...
class InquireActivity : BaseActivity(), ImplToolbar {
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        binding.textInquireType.setOnClickListener {
            ...
            builder.setTitle(getString(R.string.word_inquire_type))
            ...
            builder.setStyle_alert(AlertBuilder.STYLE_ALERT.LIST_CENTER).setOnAlertResultListener(object : OnAlertResultListener {
                ...
                override fun onResult(event_alert: AlertBuilder.EVENT_ALERT) {
                    when (event_alert.value) {
                        ...
                        2 -> {
                            mType = "partnership"
                            binding.textInquireType.text = getString(R.string.word_partnership)
                        }
                        3 -> {
                            mType = "error"
                            binding.textInquireType.text = getString(R.string.word_error)
                        }
                        4 -> {
                            mType = "etc"
                            binding.textInquireType.text = getString(R.string.word_etc)
                        }
                    }
                }
            }).builder().show(this)
