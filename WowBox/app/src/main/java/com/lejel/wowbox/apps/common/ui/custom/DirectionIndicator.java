...
public class DirectionIndicator extends LinearLayout {
    ...
    private int mImageResId = R.drawable.ic_indi;
    ...
    public void build(int orientation, int count) {
        ...
        for (int i = 0; i < mIndicatorCount; i++) {
            ...
            if (orientation == LinearLayout.HORIZONTAL) {
                ...
                lp.rightMargin = getContext().getResources().getDimensionPixelSize(R.dimen.height_33);
            } else {
                lp = new LayoutParams(
                        getContext().getResources().getDimensionPixelSize(R.dimen.width_36),
                        getContext().getResources().getDimensionPixelSize(R.dimen.width_36));
