    ...
    override fun init() {
        ...
        binding.editWithdrawalAuthConfirmNumber.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(p0: Editable?) {
                if (p0?.length == 6) {
                    binding.textWithdrawalAuthConirm.setBackgroundResource(R.drawable.bg_ea5506_radius_27)
                } else {
                    binding.textWithdrawalAuthConirm.setBackgroundResource(R.drawable.bg_dcdcdc_radius_27)
                }
            }
        })
