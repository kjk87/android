 ...
 * Use the [LuckyDrawByGroupFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class LuckyDrawByGroupFragment : BaseFragment<BaseActivity>() { //    private var param1: String? = null
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(luckyDrawGroup: LuckyDrawGroup) = LuckyDrawByGroupFragment().apply {
