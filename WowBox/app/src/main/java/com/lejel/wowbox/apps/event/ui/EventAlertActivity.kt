...
import com.lejel.wowbox.databinding.ActivityEventAlertBinding
...
//                    val remainSecond = remainMillis / 1000
                    ...
                    if (event.eventTime == null || event.eventTime!!.isEmpty()) {
                        binding.textEventAlert2.visibility = View.GONE
                    } else {
                        binding.textEventAlert2.visibility = View.VISIBLE
                        ...
                        for (time in event.eventTime!!) {
                            timeString += "${time.startTime!!.substring(0, 2)}:${time.startTime!!.substring(2)} ~ ${time.endTime!!.substring(0, 2)}:${time.endTime!!.substring(2)}"

                            index++
                            if (event.eventTime!!.size > index) {
                                timeString += "\n"
                            }
                        }
