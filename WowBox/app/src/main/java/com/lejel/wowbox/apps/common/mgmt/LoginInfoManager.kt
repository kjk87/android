...
class LoginInfoManager {
    ...
    fun load() {
        val data = PreferenceUtil.getDefaultPreference(WowBoxApplication.context).getString(SHARED_LOGIN_INFO)
    ...
    fun save() {
        ...
        PreferenceUtil.getDefaultPreference(WowBoxApplication.context).put(SHARED_LOGIN_INFO, data)
