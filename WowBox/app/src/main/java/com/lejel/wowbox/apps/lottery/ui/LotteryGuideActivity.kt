...
import com.lejel.wowbox.apps.giftcard.ui.GiftCardBrandActivity
import com.lejel.wowbox.core.network.ApiBuilder
import com.lejel.wowbox.core.network.model.dto.Lottery
import com.lejel.wowbox.core.network.model.response.NewResultResponse
import com.lejel.wowbox.core.util.PplusCommonUtil
import com.lejel.wowbox.databinding.ActivityLotteryGuideBinding
            ...
            override fun onResponse(call: Call<NewResultResponse<Lottery>>?, response: NewResultResponse<Lottery>?) {
                ...
                if(response?.result != null){
                    ...
                    if(lottery.secondType == "point"){
                        ...
                        binding.textLotteryGuide1stPrice.text = getString(R.string.format_point_unit, FormatUtil.getMoneyType(lottery.secondMoney.toString()))
                    }else{
                    ...
                    if(lottery.thirdType == "point"){
                        ...
                        binding.textLotteryGuide1stPrice.text = getString(R.string.format_point_unit, FormatUtil.getMoneyType(lottery.thirdMoney.toString()))
                    }else{
                    ...
                    if(lottery.forthType == "point"){
                        ...
                        binding.textLotteryGuide1stPrice.text = getString(R.string.format_point_unit, FormatUtil.getMoneyType(lottery.forthMoney.toString()))
                    }else{
                    ...
                    if(lottery.fifthType == "point"){
                        ...
                        binding.textLotteryGuide1stPrice.text = getString(R.string.format_point_unit, FormatUtil.getMoneyType(lottery.fifthMoney.toString()))
                    }else{
