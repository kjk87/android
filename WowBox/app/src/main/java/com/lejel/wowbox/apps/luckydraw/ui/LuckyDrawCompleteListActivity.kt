...
import com.lejel.wowbox.databinding.ActivityLuckyDrawCompleteListBinding
...
class LuckyDrawCompleteListActivity : BaseActivity(), ImplToolbar {
    ...
    override fun getToolbarOption(): ToolbarOption {
        ...
        toolbarOption.initializeDefaultToolbar(getString(R.string.word_winner_by_times), ToolbarOption.ToolbarMenu.LEFT)
