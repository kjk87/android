...
import com.lejel.wowbox.databinding.HeaderLottoWinnerBinding
import com.lejel.wowbox.databinding.ItemLotteryWinStatusBinding
import com.lejel.wowbox.databinding.ItemLotteryWinnerBinding
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is ViewHeader) {
            ...
            if (LoginInfoManager.getInstance().isMember()) {
                ...
                holder.binding.textLottoWinnerMyResult.setBackgroundResource(R.drawable.bg_dcdcdc_radius_27)
                ...
                ApiBuilder.create().getMyLotteryWinCount(mLottery!!.lotteryRound!!).setCallback(object : PplusCallback<NewResultResponse<Int>> {
                    override fun onResponse(call: Call<NewResultResponse<Int>>?, response: NewResultResponse<Int>?) {
                        if (response?.result != null && response.result!! > 0) {
                            ...
                            holder.binding.textLottoWinnerMyResult.setBackgroundResource(R.drawable.bg_ea5506_radius_27)
                            holder.binding.textLottoWinnerMyResult.setOnClickListener {
                ...
                Glide.with(holder.itemView.context).load(LoginInfoManager.getInstance().member!!.profile).apply(RequestOptions().centerCrop().placeholder(PplusCommonUtil.getDefaultProfile(position)).error(PplusCommonUtil.getDefaultProfile(position))).into(holder.binding.imageLottoWinnerMyProfile)
            ...
            lottoStatusBinding.layoutLotteryWinStatus.setBackgroundColor(ResourceUtil.getColor(holder.itemView.context, R.color.color_eeeeee))
            when (mLottery!!.firstType) {
                ...
                "cash" -> {
                    lottoStatusBinding.textLotteryWinStatusTotalPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLottery!!.firstMoney.toString()))
                    lottoStatusBinding.textLotteryWinStatusPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLotteryWinCondition!!.firstMoney.toString()))
                }
                "lotto" -> {
            ...
            when (mLottery!!.secondType) {
                ...
                "cash" -> {
                    lottoStatusBinding.textLotteryWinStatusTotalPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLottery!!.secondMoney.toString()))
                    lottoStatusBinding.textLotteryWinStatusPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLotteryWinCondition!!.secondMoney.toString()))
                }
                "lotto" -> {
                    lottoStatusBinding.textLotteryWinStatusTotalPrize.text = holder.itemView.context.getString(R.string.word_lotto_ticket_en)
            ...
            when (mLottery!!.thirdType) {
                ...
                "cash" -> {
                    lottoStatusBinding.textLotteryWinStatusTotalPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLottery!!.thirdMoney.toString()))
                    lottoStatusBinding.textLotteryWinStatusPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLotteryWinCondition!!.thirdMoney.toString()))
                }
                "lotto" -> {
                    lottoStatusBinding.textLotteryWinStatusTotalPrize.text = holder.itemView.context.getString(R.string.word_lotto_ticket_en)
            ...
            when (mLottery!!.forthType) {
                ...
                "cash" -> {
                    lottoStatusBinding.textLotteryWinStatusTotalPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLottery!!.forthMoney.toString()))
                    lottoStatusBinding.textLotteryWinStatusPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLotteryWinCondition!!.forthMoney.toString()))
                }
                "lotto" -> {
                    lottoStatusBinding.textLotteryWinStatusTotalPrize.text = holder.itemView.context.getString(R.string.word_lotto_ticket_en)
            ...
            when (mLottery!!.fifthType) {
                ...
                "cash" -> {
                    lottoStatusBinding.textLotteryWinStatusTotalPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLottery!!.fifthMoney.toString()))
                    lottoStatusBinding.textLotteryWinStatusPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(mLotteryWinCondition!!.fifthMoney.toString()))
                }
                "lotto" -> {
                    lottoStatusBinding.textLotteryWinStatusTotalPrize.text = holder.itemView.context.getString(R.string.word_lotto_ticket_en)
            ...
            Glide.with(holder.itemView.context).load(Const.API_URL+"profile/${item.userKey}").apply(RequestOptions().diskCacheStrategy(DiskCacheStrategy.NONE).centerCrop().placeholder(PplusCommonUtil.getDefaultProfile(position)).error(PplusCommonUtil.getDefaultProfile(position))).into(holder.binding.imageLotteryWinnerProfile)
...
//            }
            ...
            when (item.giftType) {
                ...
                "cash" -> {
                    holder.binding.textLotteryWinnerPrize.text = holder.itemView.context.getString(R.string.format_money_unit, FormatUtil.getMoneyType(item.money.toString()))
                }
                "lotto" -> {
