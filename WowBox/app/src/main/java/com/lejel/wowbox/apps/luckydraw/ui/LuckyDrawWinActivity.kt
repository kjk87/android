...
import com.lejel.wowbox.apps.luckydraw.data.LuckyDrawWinAdapter
...
import com.lejel.wowbox.databinding.ActivityLuckyDrawWinBinding
...
class LuckyDrawWinActivity : BaseActivity(), ImplToolbar {
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        if(mLuckyDraw.announceType == "live" && StringUtils.isNotEmpty(mLuckyDraw.liveUrl)) {
            binding.layoutLuckyDrawWinLive.visibility = View.VISIBLE
            binding.layoutLuckyDrawWinLive.setOnClickListener{
                val intent = Intent(Intent.ACTION_VIEW, Uri.parse(mLuckyDraw.liveUrl))
                startActivity(intent)
            }
        }else{
            binding.layoutLuckyDrawWinLive.visibility = View.GONE
        }

        binding.textLuckyDrawWinDrawTitle.text = mLuckyDraw.title
        binding.textLuckyDrawWinTotalPrice.text = getString(R.string.format_money_unit, FormatUtil.getMoneyTypeFloat(mLuckyDraw.totalPrice.toString()))
