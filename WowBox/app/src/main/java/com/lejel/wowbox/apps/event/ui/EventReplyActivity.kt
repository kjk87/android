...
import com.lejel.wowbox.apps.event.data.EventReplyAdapter
import com.lejel.wowbox.apps.event.data.EventReplyHeaderAdapter
import com.lejel.wowbox.core.network.ApiBuilder
import com.lejel.wowbox.core.network.model.dto.EventReply
import com.lejel.wowbox.core.network.model.dto.EventReview
...
import com.lejel.wowbox.databinding.ActivityEventReplyBinding
...
class EventReplyActivity : BaseActivity(), ImplToolbar {
    ...
    private var mAdapter: EventReplyHeaderAdapter? = null
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        mAdapter = EventReplyHeaderAdapter(mEventWin!!)
        ...
        mAdapter!!.setOnItemClickListener(object : EventReplyHeaderAdapter.OnItemClickListener {
        ...
        binding.editEventReplyInsert.setOnClickListener {
            ...
            params.eventWinSeqNo = mEventWin!!.seqNo
    ...
    private fun delete(seqNo:Long){
        showProgress("")
        ApiBuilder.create().deleteEventReply(seqNo).setCallback(object : PplusCallback<NewResultResponse<Any>> {
            override fun onResponse(call: Call<NewResultResponse<Any>>?,
                                    response: NewResultResponse<Any>?) {
                hideProgress()
    ...
    private fun listCall(page: Int) {
        ...
        params["eventWinSeqNo"] = mEventWin!!.seqNo.toString()
        ...
        ApiBuilder.create().getEventReplyList(params).setCallback(object : PplusCallback<NewResultResponse<ListResultResponse<EventReply>>> {
            override fun onResponse(call: Call<NewResultResponse<ListResultResponse<EventReply>>>?,
                                    response: NewResultResponse<ListResultResponse<EventReply>>?) {
                hideProgress()
            ...
            override fun onFailure(call: Call<NewResultResponse<ListResultResponse<EventReply>>>?,
                                   t: Throwable?,
                                   response: NewResultResponse<ListResultResponse<EventReply>>?) {
                hideProgress()
            }
    ...
    override fun getToolbarOption(): ToolbarOption {
        ...
        toolbarOption.initializeDefaultToolbar(getString(R.string.word_reply), ToolbarOption.ToolbarMenu.RIGHT)
