...
import com.lejel.wowbox.databinding.ActivityPartnerReqBinding
...
class PartnerReqActivity : BaseActivity(), ImplToolbar {
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        binding.textPartnerReqProcess3Desc.text = PplusCommonUtil.fromHtml(getString(R.string.html_partner_earn_process3_desc, "0.3"))
