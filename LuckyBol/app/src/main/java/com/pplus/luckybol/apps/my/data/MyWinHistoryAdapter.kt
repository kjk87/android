...
class MyWinHistoryAdapter : RecyclerView.Adapter<MyWinHistoryAdapter.ViewHolder> {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(item.event!!.primaryType == "number"){
            holder.text_gift_name.text = holder.itemView.context.getString(R.string.format_bol_unit2, FormatUtil.getMoneyTypeFloat(item.amount.toString()))
        }else{
