...
import com.pplus.luckybol.core.network.model.dto.CountryConfig;
...
public class CountryConfigManager{
    ...
    public void load(){
        ...
        String data = PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).getString(COUNTRY_CONFIG);
    ...
    public void save(){
        ...
        PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).put(COUNTRY_CONFIG, data);
