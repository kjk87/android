...
import com.pplus.luckybol.databinding.FragmentEventBinding
...
class EventFragment : BaseFragment<BaseActivity>() {
    ...
    private fun setBuzzvil(){
        if(LoginInfoManager.getInstance().isMember && BuzzAdBenefit.getPrivacyPolicyManager()!!.isConsentGranted()){
            binding.collapsingToolbarEvent.visibility = View.VISIBLE
            val loader = NativeAdLoader(getString(R.string.buzvil_native_id_lucky))
            loader.loadAd(object : NativeAdLoader.OnAdLoadedListener {
                ...
                override fun onAdLoaded(nativeAd: NativeAd) {
                    ...
                    try{
                        val viewBinder = NativeAdViewBinder.Builder(binding.itemEventBuzzvilBanner.nativeAdView, binding.itemEventBuzzvilBanner.mediaView)
                            .titleTextView(binding.itemEventBuzzvilBanner.textBuzzvilTitle)
                            .descriptionTextView(binding.itemEventBuzzvilBanner.textBuzzvilDesc)
                            .iconImageView(binding.itemEventBuzzvilBanner.imageBuzzvilIcon)
                            .ctaView(binding.itemEventBuzzvilBanner.ctaViewBuzzvil)
                            .build()
            ...
            binding.collapsingToolbarEvent.visibility = View.GONE
        }
    }
    ...
    private fun setRetentionBol() {
        PplusCommonUtil.reloadSession(object : PplusCommonUtil.Companion.ReloadListener {
            ...
            override fun reload() {
                ...
                binding.textEventRetentionBol.text = PplusCommonUtil.fromHtml(getString(R.string.html_bol_unit, FormatUtil.getMoneyTypeFloat(LoginInfoManager.getInstance().user.totalBol.toString())))
            }
        })
    }
