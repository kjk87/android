...
//            val imgView = v as ImageView?
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        Glide.with(binding.root.context).load(glideUrl).apply(RequestOptions().centerCrop().placeholder(R.drawable.luckybol_default_img).error(R.drawable.luckybol_default_img)).into(binding.imagePostWrite)
