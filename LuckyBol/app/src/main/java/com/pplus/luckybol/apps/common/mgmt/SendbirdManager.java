...
//import com.pplus.luckybol.core.network.model.response.result.TalkChannelData;
...
//
//        return "User"+String.valueOf(LoginInfoManager.getInstance().getUser().getNo());
//    }
//
...
//
//        Context context = LuckyBolApplication.getContext();
//
