...
import com.pplus.luckybol.databinding.ItemNumberEventBinding
 ...
 */
class NumberEventAdapter() : RecyclerView.Adapter<NumberEventAdapter.ViewHolder>() {

    var mDataList: MutableList<Event>? = null
    var listener: OnItemClickListener? = null
    var mNumberEventFragment:NumberEventFragment? = null
    ...
    class ViewHolder(binding: ItemNumberEventBinding) : RecyclerView.ViewHolder(binding.root) {

        val image = binding.imageNumberEvent
        val text_time = binding.textNumberEventTime
        val layout_close = binding.layoutNumberEventClose
        val text_win_time = binding.textNumberEventWinTime
        val text_proceeding = binding.textNumberEventProceeding
        val image_win_result = binding.imageNumberEventWinResult
...
//                            if (mContext != null) {
//                                Glide.with(mContext).load(item.winImageUrl).apply(RequestOptions().centerCrop().placeholder(R.drawable.luckybol_default_img).error(R.drawable.luckybol_default_img)).into(holder.image)
//                                holder.layout_close.visibility = View.GONE
//                                isClose = false
//                                isWinAnnounce = true
//                            }
...
//                holder.text_proceeding.visibility = View.VISIBLE
        ...
        holder.itemView.setOnClickListener {
            if (isClose) {
                ...
                if(mNumberEventFragment != null){
                    launcher = mNumberEventFragment!!.defaultLauncher
                }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemNumberEventBinding.inflate(LayoutInflater.from(parent.context), parent, false)
