...
import com.pplus.luckybol.apps.alert.AlertGiftReviewActivity
import com.pplus.luckybol.apps.common.toolbar.ImplToolbar
import com.pplus.luckybol.apps.common.toolbar.OnToolbarListener
import com.pplus.luckybol.apps.common.toolbar.ToolbarOption
import com.pplus.luckybol.apps.common.ui.base.BaseActivity
import com.pplus.luckybol.apps.goods.ui.CheckAuthCodeActivity
...
import com.pplus.luckybol.databinding.ActivityEventWinDetailBinding
...
class EventWinDetailActivity : BaseActivity(), ImplToolbar {
        ...
        ApiBuilder.create().getWinBySeqNo(params).setCallback(object : PplusCallback<NewResultResponse<EventWin>> {
            override fun onResponse(call: Call<NewResultResponse<EventWin>>?, response: NewResultResponse<EventWin>?) {
                ...
                if (response?.data != null) {
                    ...
                    Glide.with(this@EventWinDetailActivity).load(mEventWin!!.gift!!.giftImageUrl).apply(RequestOptions().centerCrop().placeholder(R.drawable.luckybol_default_img).error(R.drawable.luckybol_default_img)).into(binding.imageEventWinDetailGift)
                    ...
                    if (mEventWin!!.gift!!.reviewPoint != null && mEventWin!!.gift!!.reviewPoint!! > 0) {
                        ...
                        binding.textEventWinDetailGiftReviewPoint.text = getString(R.string.format_bol_unit, FormatUtil.getMoneyType(mEventWin!!.gift!!.reviewPoint.toString()))
                    } else {
                    ...
                    when (mEventWin!!.giftStatus) {
                        EnumData.GiftStatus.wait.status -> {
                            binding.textEventWinDetailGiftUse.setBackgroundColor(ResourceUtil.getColor(this@EventWinDetailActivity, R.color.color_fc5c57))
    ...
    private fun getPage(pageSeqNo: Long) {
        ...
        ApiBuilder.create().getPage(params).setCallback(object : PplusCallback<NewResultResponse<Page>> {
            ...
            override fun onResponse(call: Call<NewResultResponse<Page>>?,
                                    response: NewResultResponse<Page>?) {
                hideProgress()
                if (response?.data != null) {
                    mPage = response.data!!

                    binding.textEventWinDetailPageName.text = mPage!!.name
                    //                    layout_event_win_detail_page_go.setOnClickListener {
            ...
            override fun onFailure(call: Call<NewResultResponse<Page>>?,
                                   t: Throwable?,
                                   response: NewResultResponse<Page>?) {
                hideProgress()
            }
            ...
            ApiBuilder.create().updateUseGift(params).setCallback(object : PplusCallback<NewResultResponse<Any>>{
                override fun onResponse(call: Call<NewResultResponse<Any>>?, response: NewResultResponse<Any>?) {
                    ...
                    if(mEventWin!!.gift!!.reviewPoint != null && mEventWin!!.gift!!.reviewPoint!! > 0){
                        ...
                        alertReviewLauncher.launch(intent)
                    }else{
    ...
    val alertReviewLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
