...
public class ImageDeleteAdapter extends RecyclerView.Adapter<ImageDeleteAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(final ViewHolder holder, int position){
        ...
        Glide.with(context).load(item.getPath()).apply(new RequestOptions().centerCrop().placeholder(R.drawable.luckybol_default_img).error(R.drawable.luckybol_default_img).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true)).into(holder.image_delete_image);
