...
import com.pplus.luckybol.databinding.ItemMobileGiftHistoryBinding
...
class GiftishowBuyHistoryAdapter() : RecyclerView.Adapter<GiftishowBuyHistoryAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(holder.itemView.context).load(item.giftishow!!.goodsImgS).apply(RequestOptions().centerCrop().placeholder(R.drawable.luckybol_default_img).error(R.drawable.luckybol_default_img)).into(holder.image)
