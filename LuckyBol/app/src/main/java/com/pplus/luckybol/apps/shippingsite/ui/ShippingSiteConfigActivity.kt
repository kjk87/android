...
import com.pplus.luckybol.apps.shippingsite.data.ShippingSiteAdapter
import com.pplus.luckybol.core.network.ApiBuilder
import com.pplus.luckybol.core.network.model.dto.ShippingSite
import com.pplus.luckybol.core.network.model.response.NewResultResponse
import com.pplus.luckybol.databinding.ActivityShippingSiteConfigBinding
        ...
        ApiBuilder.create().shippingSiteList.setCallback(object : PplusCallback<NewResultResponse<ShippingSite>>{
            override fun onResponse(call: Call<NewResultResponse<ShippingSite>>?, response: NewResultResponse<ShippingSite>?) {
                ...
                if(response?.datas != null){
                    ...
                    mAdapter!!.setDataList(response.datas!! as MutableList<ShippingSite>)
                }
            }
        ...
        return OnToolbarListener { v, toolbarMenu, tag ->
            when (toolbarMenu) {
                ...
                ToolbarOption.ToolbarMenu.RIGHT -> if (tag == 1) {
                    val intent = Intent(this, ShippingSiteRegActivity::class.java)
