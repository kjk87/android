 ...
 */
class BottomHideBehavior<V : View>(context: Context?, attrs: AttributeSet? = null
  ...
  companion object {
    ...
    fun <V : View> from(view: V?): BottomHideBehavior<V>? {
      ...
      return params.behavior as? BottomHideBehavior<V>
    }
  }
