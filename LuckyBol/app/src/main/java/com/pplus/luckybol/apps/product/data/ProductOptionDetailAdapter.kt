...
import com.pplus.luckybol.databinding.ItemGoodsOptionItemBinding
...
class ProductOptionDetailAdapter(var optionType: String? = null) : RecyclerView.Adapter<ProductOptionDetailAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(optionType == EnumData.OptionType.union.name){
            ...
            if (remainCount > 0) {
                holder.text_count.setTextColor(ResourceUtil.getColor(holder.itemView.context, R.color.color_fc5c57))
