...
import com.pplus.luckybol.databinding.ActivityGiftishowDetailBinding
...
class GiftishowDetailActivity : BaseActivity(), ImplToolbar {
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        Glide.with(this).load(mGiftishow!!.goodsImgB).apply(RequestOptions().centerCrop().placeholder(R.drawable.luckybol_default_img).error(R.drawable.luckybol_default_img)).into(binding.imageGiftishowDetail)
        binding.textGiftishowDetailName.text = mGiftishow!!.goodsName
        binding.textGiftishowDetailPrice.text = PplusCommonUtil.fromHtml(getString(R.string.html_cash_unit, FormatUtil.getMoneyType(mGiftishow!!.realPrice)))
