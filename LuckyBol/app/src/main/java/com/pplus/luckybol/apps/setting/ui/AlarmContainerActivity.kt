...
import com.pplus.luckybol.apps.setting.data.NotificationBoxAdapter
...
import com.pplus.luckybol.databinding.ActivityAlarmContainerBinding
import com.pplus.luckybol.databinding.ItemTopSwitchBinding
                ...
                if (item.moveType1 == "inner") {
                    ...
                    when (item.moveType2) {
                        ...
                        MoveType2Code.pageDetail.name -> {
                            ...
                            //                        val page = Page()
                            //                        page.no = java.lang.Long.valueOf(item.moveTarget.no!!)
