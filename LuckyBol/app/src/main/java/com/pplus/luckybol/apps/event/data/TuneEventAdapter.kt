...
import com.pplus.luckybol.databinding.ItemTuneEventBinding
...
class TuneEventAdapter : RecyclerView.Adapter<TuneEventAdapter.ViewHolder> {
    ...
    var mTuneEventGroupAFragment: TuneEventGroupAFragment? = null
    var mTuneEventGroupBFragment: TuneEventGroupBFragment? = null
...
//            text_title.setSingleLine()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(item.groupSeqNo == 1L){
            holder.layout_image.layoutParams.height = holder.itemView.context.resources.getDimensionPixelSize(R.dimen.height_400)
        }else{
...
//                holder.text_proceeding.visibility = View.VISIBLE
        ...
        holder.itemView.setOnClickListener {
            if (isClose) {
                if(mTuneEventGroupBFragment != null){
                    PplusCommonUtil.showEventAlert(holder.itemView.context, 0, item, mTuneEventGroupBFragment!!.defaultLauncher)
                }else if(mTuneEventGroupAFragment != null){
                    PplusCommonUtil.showEventAlert(holder.itemView.context, 0, item, mTuneEventGroupAFragment!!.defaultLauncher)
                }
