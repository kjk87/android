...
import com.pplus.luckybol.databinding.FragmentLoginBinding
...
//        image_login_facebook.setOnClickListener {
...
//                }
//            })
//            FaceBookUtil.logInWithPublicProfile(this)
//            showProgress("")
//        }

//        image_login_google.setOnClickListener {
//            showProgress("")
...
//        image_login_kakao.setOnClickListener {
        ...
        ApiBuilder.create().existsDevice(params).setCallback(object : PplusCallback<NewResultResponse<User>> {
            ...
            override fun onResponse(call: Call<NewResultResponse<User>>, response: NewResultResponse<User>) {
                ...
                if(response.data == null || response.data!!.device == null){
                    ...
                    if (StringUtils.isNotEmpty(AppInfoManager.getInstance().pushToken) && (response.data!!.device!!.installedApp == null || StringUtils.isEmpty(response.data!!.device!!.installedApp.pushKey) || AppInfoManager.getInstance().pushToken != response.data!!.device!!.installedApp.pushKey)) {
