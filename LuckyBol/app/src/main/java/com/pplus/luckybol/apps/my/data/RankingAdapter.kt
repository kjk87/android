...
//            Glide.with(holder.itemView.context).load(item.profileImage!!.url).apply(RequestOptions().centerCrop().placeholder(R.drawable.luckybol_default_img).error(R.drawable.ic_event_profile_default)).into(holder.image)
//        } else {
...
//                holder.text_info.text = mContext?.getString(R.string.format_bol_unit, FormatUtil.getMoneyType(item.rankingCount.toString()))
//            }
//        }
//
//    }
