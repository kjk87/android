...
import com.pplus.luckybol.databinding.ActivityAppSettingBinding
import com.pplus.luckybol.databinding.ItemAppSettingCBinding
import com.pplus.luckybol.databinding.ItemAppSettingHBinding
...
//        childList.add(resources.getStringArray(R.array.setting_pay))
        ...
        for (i in headers.indices) {
            ...
            for (j in 0 until childList[i].size) {
                ...
                if (i == 1 && j == 1) {
                    appSettingCBinding.textAppSettingConfigValue.setTextColor(ContextCompat.getColor(this, R.color.color_fc5c57))
                    try {
