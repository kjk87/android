package com.pplus.luckybol.push
...
class NotiManager(private val context: Context) {
    ...
    companion object {
        private val CHANNEL_ID = "com.pplus.luckybol.NOTI"
        private val CHANNEL_NAME = LuckyBolApplication.getContext().getString(R.string.app_name)
        private val CHANNEL_DESCRIPTION = LuckyBolApplication.getContext().getString(R.string.app_name)
    }
