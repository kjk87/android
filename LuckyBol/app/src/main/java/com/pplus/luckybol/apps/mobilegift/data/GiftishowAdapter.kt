...
import com.pplus.luckybol.databinding.ItemMobileGiftBinding
...
class GiftishowAdapter() : RecyclerView.Adapter<GiftishowAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(holder.itemView.context).load(item.goodsImgS).apply(RequestOptions().centerCrop().placeholder(R.drawable.luckybol_default_img).error(R.drawable.luckybol_default_img)).into(holder.image)
        holder.text_price.text = PplusCommonUtil.fromHtml(holder.itemView.context.getString(R.string.html_cash_unit, FormatUtil.getMoneyType(item.realPrice)))
