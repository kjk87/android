package com.pplus.luckybol.apps.common.mgmt;//package com.pplus.luckybol.apps.common.mgmt;
//
...
//import com.pplus.luckybol.core.network.model.dto.StepAddress;
...
//    public void load(){
//
//        String data = PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).getString(SHARED_BASE_ADDRESS);
...
//        PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).put(SHARED_BASE_ADDRESS, data);
//    }
//
//    public void clear(){
//
