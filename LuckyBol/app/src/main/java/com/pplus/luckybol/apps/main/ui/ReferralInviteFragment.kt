...
import com.pplus.luckybol.databinding.FragmentReferralInviteBinding

class ReferralInviteFragment : BaseFragment<BaseActivity>() {
    ...
    private var _binding: FragmentReferralInviteBinding? = null
    private val binding get() = _binding!!

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        _binding = FragmentReferralInviteBinding.inflate(inflater, container, false)
...
//        val recommendPoint = FormatUtil.getMoneyTypeFloat(CountryConfigManager.getInstance().config.properties.recommendBol.toString())
        ...
        binding.textReferralInviteDesc.text = PplusCommonUtil.fromHtml(getString(R.string.html_invite_desc3))
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() = ReferralInviteFragment().apply {
