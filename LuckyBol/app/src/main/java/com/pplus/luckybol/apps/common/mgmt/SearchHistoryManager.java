...
public class SearchHistoryManager{
    ...
    public void save(){
        ...
        PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).put(SHARED_SEARCH_HISTORY, data);
    }

    public void load(){

        String data = PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).getString(SHARED_SEARCH_HISTORY);
        Type type = new TypeToken<ArrayList<String>>(){
