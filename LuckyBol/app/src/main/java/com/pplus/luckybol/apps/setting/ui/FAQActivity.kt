...
import com.pplus.luckybol.apps.setting.data.FaqAdapter
import com.pplus.luckybol.core.network.ApiBuilder
import com.pplus.luckybol.core.network.model.dto.Faq
import com.pplus.luckybol.core.network.model.dto.FaqGroup
import com.pplus.luckybol.core.network.model.response.NewResultResponse
import com.pplus.luckybol.databinding.ActivityFaqBinding
import com.pplus.luckybol.databinding.ItemToolbarListRowBinding
...
class FAQActivity : BaseActivity(), ImplToolbar {
        ...
        ApiBuilder.create().getFaqGroupAll(params).setCallback(object : PplusCallback<NewResultResponse<FaqGroup>> {
            override fun onResponse(call: Call<NewResultResponse<FaqGroup>>?,
                ...
                if (response?.datas != null) {
                    groupList!!.addAll(response.datas!!)
                }
    ...
    private fun listCall(page: Int) {
        ...
        ApiBuilder.create().getFaqList(params).setCallback(object : PplusCallback<NewResultResponse<Faq>> {
            override fun onResponse(call: Call<NewResultResponse<Faq>>?,
                                    response: NewResultResponse<Faq>?) {
                hideProgress()
                if(response?.datas != null){
                    mLockListView = false
            ...
            override fun onFailure(call: Call<NewResultResponse<Faq>>?,
                                   t: Throwable?,
                                   response: NewResultResponse<Faq>?) {
                hideProgress()
            }
