...
import com.pplus.luckybol.apps.product.data.PurchaseProductShippingHistoryAdapter
...
import com.pplus.luckybol.databinding.FragmentBuyHistoryBinding
...
class PurchaseProductShippingHistoryFragment : BaseFragment<BaseActivity>() {
    ...
    override fun init() {
        ...
        mAdapter!!.launcher = refreshLauncher
...
//        recycler_main_page.addItemDecoration(CustomItemOffsetDecoration(activity!!, R.dimen.height_60, R.dimen.height_60))
    ...
    val refreshLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
