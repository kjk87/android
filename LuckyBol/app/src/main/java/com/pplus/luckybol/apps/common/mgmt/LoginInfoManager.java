...
public class LoginInfoManager {
    ...
    public void load(){
        ...
        String data = PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).getString(SHARED_LOGIN_INFO);
    ...
    public void save(){
        ...
        PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).put(SHARED_LOGIN_INFO, data);
