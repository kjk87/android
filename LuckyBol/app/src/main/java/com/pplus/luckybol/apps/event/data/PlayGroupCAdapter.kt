...
// */
//class PlayGroupCAdapter : RecyclerView.Adapter<PlayGroupCAdapter.ViewHolder> {
//
...
//
//        val layout_image = binding.layoutPlayImage
...
//
//        val item: Event = mDataList!![position]
//
//        holder.layout_image.layoutParams.height = holder.itemView.context.resources.getDimensionPixelSize(R.dimen.height_540)
//
