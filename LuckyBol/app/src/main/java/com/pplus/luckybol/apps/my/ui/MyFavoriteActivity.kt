...
import com.pplus.luckybol.apps.my.data.CategoryMinorAdapter
import com.pplus.luckybol.apps.my.data.MyFavoriteAdapter
import com.pplus.luckybol.core.network.ApiBuilder
import com.pplus.luckybol.core.network.model.dto.CategoryFavorite
import com.pplus.luckybol.core.network.model.dto.CategoryMajor
import com.pplus.luckybol.core.network.model.dto.CategoryMinor
import com.pplus.luckybol.core.network.model.response.NewResultResponse
import com.pplus.luckybol.core.util.PplusCommonUtil
import com.pplus.luckybol.core.util.ToastUtil
import com.pplus.luckybol.databinding.ActivityMyFavoriteBinding
import com.pplus.networks.common.PplusCallback
import retrofit2.Call

class MyFavoriteActivity : BaseActivity(), ImplToolbar {
    override fun getPID(): String {
        return "Main_mypage_profile_Interest"
    }
    ...
    private fun getCategoryList() {
        ...
        ApiBuilder.create().categoryMajor.setCallback(object : PplusCallback<NewResultResponse<CategoryMajor>>{
            override fun onResponse(call: Call<NewResultResponse<CategoryMajor>>?, response: NewResultResponse<CategoryMajor>?) {
                if(response?.datas != null){
                    hideProgress()
                    mAdapter!!.setDataList(response.datas!! as MutableList<CategoryMajor>)
                }
            }
