...
import com.pplus.luckybol.core.network.model.dto.PurchaseProductOption
import com.pplus.luckybol.databinding.ItemPurchaseProductShipBinding
...
class PurchaseProductShipAdapter(purchaseProduct: PurchaseProduct) : RecyclerView.Adapter<PurchaseProductShipAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(item.productOptionDetailSeqNo == null){
            ...
            price = mPurchaseProduct.productPriceData!!.price!!.toInt() * mPurchaseProduct.count!!
            ...
            price = (mPurchaseProduct.productPriceData!!.price!!.toInt() + item.price!!)*item.amount!!
        }
