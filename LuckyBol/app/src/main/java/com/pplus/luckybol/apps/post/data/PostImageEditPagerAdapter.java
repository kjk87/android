package com.pplus.luckybol.apps.post.data;
...
import com.pplus.luckybol.apps.post.ui.PostImageEditActivity;
...
public class PostImageEditPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position){
        ...
        Glide.with(mContext).load(data.getPath()).apply(new RequestOptions().centerCrop().placeholder(R.drawable.luckybol_default_img).error(R.drawable.luckybol_default_img).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true)).into(imageView);
