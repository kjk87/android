...
import com.pplus.luckybol.apps.common.component.autofit.AutofitTextView
import com.pplus.luckybol.apps.common.ui.base.BaseActivity
import com.pplus.luckybol.core.util.PplusCommonUtil
import com.pplus.luckybol.databinding.ActivityAlertBinding
import com.pplus.luckybol.databinding.ItemAlertTextLayoutBinding
...
class AlertActivity : BaseActivity(), View.OnClickListener {
    ...
    @ColorRes
    private val alertMessageColor = R.color.color_525961
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        if (alertResult!!.alertData != null) {
            ...
            if (StringUtils.isEmpty(alertResult!!.alertData.title)) {
                ...
                binding.textAlertTitle.setTextColor(ResourceUtil.getColor(this, R.color.color_fc5c57))
            }
                ...
                for (data in messageDatas) {
                    ...
                    when (data.message_type) {
                        MESSAGE_TYPE.HTML -> {
                            ...
                            //                            } else {
                            result = PplusCommonUtil.fromHtml(data.contents) //                            }
