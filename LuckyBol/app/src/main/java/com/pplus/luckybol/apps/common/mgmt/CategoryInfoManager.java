...
public class CategoryInfoManager{
    ...
    public void load(){
        ...
        String data = PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).getString(SHARED_CATEGORY_INFO);
    ...
    public void save(){
        ...
        PreferenceUtil.getDefaultPreference(LuckyBolApplication.getContext()).put(SHARED_CATEGORY_INFO, data);
    }
