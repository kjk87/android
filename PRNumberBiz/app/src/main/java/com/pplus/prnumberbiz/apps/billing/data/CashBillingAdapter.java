 ...
 */
public class CashBillingAdapter extends RecyclerView.Adapter<CashBillingAdapter.ViewHolder>{
    ...
    public CashBillingAdapter(Context context){
    ...
    public void onBindViewHolder(final ViewHolder holder, int position){
        ...
        holder.text_cash.setText(FormatUtil.getMoneyType(item.getAmount())+ " " + context.getString(R.string.word_cash_en));
        holder.text_krw.setText(holder.itemView.getContext().getString(R.string.format_money_unit, FormatUtil.getMoneyType(item.getAmount())));
