package com.pplus.prnumberbiz.apps.common.builder;
...
public class AlertBuilder implements Serializable{
    ...
    public static class Builder{
        ...
        public Builder setArrayContents(List<String> contents){

            List<String> result = contents;

            messageData = new AlertData.MessageData[result.size()];
            for(int i = 0; i < result.size(); i++) {
                AlertData.MessageData message = new AlertData.MessageData(result.get(i), MESSAGE_TYPE.TEXT, maxLine);
