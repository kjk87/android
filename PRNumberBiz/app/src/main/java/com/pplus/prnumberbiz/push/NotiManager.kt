package com.pplus.prnumberbiz.push
...
class NotiManager(private val context: Context) {
    ...
    companion object {
        private val CHANNEL_ID = "com.pplus.prnumberbiz.NOTI"
        private val CHANNEL_NAME = PRNumberBizApplication.getContext().getString(R.string.app_name)
        private val CHANNEL_DESCRIPTION = PRNumberBizApplication.getContext().getString(R.string.app_name)
    }
