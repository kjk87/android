...
class MainPagerAdapter : androidx.viewpager.widget.PagerAdapter {
    ...
    var imageRes = intArrayOf(R.drawable.img_keyword_banner_1, R.drawable.img_keyword_banner_2, R.drawable.img_keyword_banner_3)
...
//        this.mContext = context
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val image = view.findViewById<ImageView>(R.id.image_main_pager)
