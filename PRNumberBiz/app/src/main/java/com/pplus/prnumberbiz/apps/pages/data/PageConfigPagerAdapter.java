...
public class PageConfigPagerAdapter extends PagerAdapter {
    ...
    public PageConfigPagerAdapter(final Context context) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        View view = mInflater.inflate(R.layout.item_page_config, container, false);

        ImageView imageView = view.findViewById(R.id.image_page_config);
        ImageView imagePlay = view.findViewById(R.id.image_page_config_youtube_play);
        ImageView imageDelete = view.findViewById(R.id.image_page_config_delete);
