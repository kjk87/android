...
import com.pplus.prnumberbiz.apps.post.data.PostHeaderCommentAdapter
...
class PostDetailActivity : BaseActivity(), ImplToolbar {
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        recycler_review_detail_reply.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(this, androidx.recyclerview.widget.OrientationHelper.VERTICAL, false)
    ...
    private fun getPost() {
        ...
        ApiBuilder.create().getPost(mPost!!.no).setCallback(object : PplusCallback<NewResultResponse<Post>> {
            ...
            override fun onResponse(call: Call<NewResultResponse<Post>>, response: NewResultResponse<Post>) {
                ...
                val havSameFriends = mPost!!.author != null && mPost!!.author!!.haveSameFriends

                mPost = response.data

                mPost!!.author!!.haveSameFriends = havSameFriends
