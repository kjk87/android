...
// */
//public class NoteReceiveAdapter extends RecyclerView.Adapter<NoteReceiveAdapter.ViewHolder>{
//
//    private static final String TAG = NoteReceiveAdapter.class.getSimpleName();
...
//        }
//
//        if(item.getReplyNo() != null){
//            holder.image_reply.setVisibility(View.VISIBLE);
//        }else{
//            holder.image_reply.setVisibility(View.GONE);
//        }
//
//
//
...
//            image_reply = itemView.findViewById(R.id.image_note_container_reply);
//        }
//
//    }
//
