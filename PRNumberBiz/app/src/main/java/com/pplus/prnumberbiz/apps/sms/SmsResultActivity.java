...
import com.pplus.prnumberbiz.apps.push.ui.PushResultDetailActivity;
...
public class SmsResultActivity extends BaseActivity implements ImplToolbar, View.OnClickListener{
    ...
    public void initializeView(Bundle savedInstanceState){
        ...
        mAdapter.setOnItemClickListener(new PushListAdapter.OnItemClickListener(){
            ...
            public void onItemClick(int position){
                ...
                Intent intent = new Intent(SmsResultActivity.this, PushResultDetailActivity.class);
            ...
            public void onResponse(Call<NewResultResponse<Integer>> call, NewResultResponse<Integer> response){
                ...
                if(mTotalCount == 0) {
                    if(mStatus.equals(EnumData.MsgStatus.finish)) {
                        ...
                        text_totalCount.setText(R.string.msg_not_exist_reservation_sms);
                    }
                }else{
                    text_totalCount.setText(PplusCommonUtil.Companion.fromHtml(getString(R.string.html_total_count3, mTotalCount)));
                }
