...
class Category(var no: Long? = null,
    ...
    override fun toString(): String {
        ...
        return "Category{" + "no=" + no + ", depth=" + depth + ", name='" + name + '\''.toString() + ", iconUrl='" + iconUrl + '\''.toString() + ", priority=" + priority + ", iconImageUrl='" + iconImageUrl + '\''.toString() + ", parent=" + parent + ", status='" + status + '\''.toString() + '}'.toString()
    }
