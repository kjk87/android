...
import kotlinx.android.synthetic.main.item_goods_sale_history.view.*
 ...
 */
class GoodsSaleHistoryAdapter : RecyclerView.Adapter<GoodsSaleHistoryAdapter.ViewHolder> {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val text_pay_type = itemView.text_goods_sale_history_pay_type
        val text_price = itemView.text_goods_sale_history_price
        val text_buy_user = itemView.text_goods_sale_history_buy_user
        val text_date = itemView.text_goods_sale_history_date
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (item.buy != null) {
            when (item.buy!!.payMethod) {
                "CARD" -> {
                    payMethod = mContext!!.getString(R.string.word_credit_card)
                }
                "BANK" -> {
                    payMethod = mContext!!.getString(R.string.word_real_time_transfer)
                }
            }
            holder.text_pay_type.text = payMethod
            holder.text_buy_user.text = item.buy!!.buyerName
...
//            holder.text_receiver_phone.text = item.buy!!.buyerTel
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_goods_sale_history, parent, false)
        return ViewHolder(v)
    }
}