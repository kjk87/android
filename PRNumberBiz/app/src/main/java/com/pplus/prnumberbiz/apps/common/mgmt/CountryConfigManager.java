...
public class CountryConfigManager{
    ...
    public void load(){
        ...
        String data = PreferenceUtil.getDefaultPreference(PRNumberBizApplication.getContext()).getString(COUNTRY_CONFIG);
    ...
    public void save(){
        ...
        PreferenceUtil.getDefaultPreference(PRNumberBizApplication.getContext()).put(COUNTRY_CONFIG, data);
