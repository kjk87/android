package com.pplus.prnumberbiz.core.sns.facebook;
...
public class FaceBookUtil{
    ...
    /**
     * public_profile 로그인 요청 mapFragment
     **/
     ...
     * public_profile 로그인 요청 activity
     **/
    public static void logInWithPublicProfile(Activity activity){
    ...
    /**
     * 로그인 permission 직접 요청 mapFragment
     **/
    ...
    public static void requestProfile(AccessToken token){
        ...
        GraphRequest request = GraphRequest.newMeRequest(token, new GraphRequest.GraphJSONObjectCallback(){
            ...
            public void onCompleted(JSONObject object, GraphResponse response){
                ...
                if(mListener != null) {
                    LogUtil.e("requestProfile", object.toString());
    ...
    public static void facebookAccounts(AccessToken accessToken){

        /* make the API call */
        new GraphRequest(accessToken, "me/accounts", null, HttpMethod.GET, new GraphRequest.Callback(){
            ...
            public void onCompleted(GraphResponse response){
                ...
                if(mListener != null) {
                    mListener.onCompleted(null, response);
                }
            }
        }).executeAsync();
    }
