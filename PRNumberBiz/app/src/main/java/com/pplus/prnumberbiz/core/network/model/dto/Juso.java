...
public class Juso implements Parcelable{
    ...
    public static final Parcelable.Creator<Juso> CREATOR = new Parcelable.Creator<Juso>(){

        @Override
        public Juso createFromParcel(Parcel source){

            return new Juso(source);
        }
