...
//                            LogUtil.e(LOG_TAG, "request body = {} ", buffer.readUtf8());
                ...
                if(!response.isSuccessful()) {
                    LogUtil.e(LOG_TAG, "response failed");
                    ...
                    LogUtil.e(LOG_TAG, gson.toString());
...
//                        ((Attachment) resultResponse.getData()).setHeight(height);
                        ...
                        if(resultResponse.getResultCode() == 560) {
                            AlertBuilder.Builder builder = new AlertBuilder.Builder();
                            builder.addContents(new AlertData.MessageData(PRNumberBizApplication.getContext().getString(R.string.msg_expire_session), AlertBuilder.MESSAGE_TYPE.TEXT, 2));
