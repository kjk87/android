...
package com.pplus.prnumberbiz.apps.billing.util;
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                mService = BillingService.Stub.asInterface(service);
        ...
        Intent serviceIntent = new Intent("com.android.vending.billing.BillingService.BIND");
