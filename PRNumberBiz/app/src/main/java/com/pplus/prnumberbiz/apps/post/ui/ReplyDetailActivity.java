...
import com.pplus.prnumberbiz.apps.post.data.ReplyDetailAdapter;
...
public class ReplyDetailActivity extends BaseActivity implements View.OnClickListener, ImplToolbar{
    ...
    public void initializeView(Bundle savedInstanceState){
        ...
        mAdapter = new ReplyDetailAdapter(this);
        recyclerView.setAdapter(mAdapter);

        not_exist = findViewById(R.id.text_reply_detail_not_exist);
        ...
        edit_reply.setHint(R.string.hint_input_reply_of_reply);
        ...
        if(mComment.getAuthor().getUseStatus() != null && mComment.getAuthor().getUseStatus().equals(EnumData.UseStatus.leave.name())){
            ...
            if(mComment.isDeleted()) {
                ...
                if(mPost != null && mPost.getType().equals(EnumData.PostType.pr.name()) && mComment.getAuthor().getNo().equals(mPost.getAuthor().getNo()) && mPost.getPage() != null) {
                    if(mPost.getAuthor().getPage().getProfileImage() != null) {
                        Glide.with(this).load(mPost.getAuthor().getPage().getProfileImage().getUrl()).apply(new RequestOptions().centerCrop().placeholder(R.drawable.ic_gift_profile_default).error(R.drawable.ic_gift_profile_default)).into(image_profileImage);
                    }
                } else {
