...
public class ToolbarOption{
    ...
    private ToolbarGravity titleGravity = ToolbarGravity.LEFT;
    ...
    public void setToolbarMenu(ToolbarMenu toolbarMenu, @DrawableRes int res, int tag){
        ...
        if(toolbarMenu.equals(ToolbarMenu.RIGHT) && res == R.drawable.ic_post_set_edit) {
            imageButton.setPadding(0, 0, context.getResources().getDimensionPixelSize(R.dimen.width_72), 0);
        }else if(toolbarMenu.equals(ToolbarMenu.RIGHT) && res != R.drawable.ic_top_close) {
            imageButton.setPadding(0, 0, context.getResources().getDimensionPixelSize(R.dimen.width_40), 0);
        }else if(toolbarMenu.equals(ToolbarMenu.LEFT)){
            imageButton.setPadding(context.getResources().getDimensionPixelSize(R.dimen.width_40), 0, 0, 0);
        }
    ...
    public void setToolbarMenu(ToolbarMenu toolbarMenu, String value, int tag, int padding){
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, context.getResources().getDimensionPixelSize(R.dimen.textSize_52pt));
...
//        textView.setTypeface(Typekit.getInstance().get(Typekit.Style.Bold));
        textView.setGravity(Gravity.CENTER);
        textView.setPadding(0, 0, context.getResources().getDimensionPixelSize(R.dimen.width_72), 0);
        textView.setTextColor(ResourceUtil.getColorStateList(context, R.color.color_579ffb));
        textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, context.getResources().getDimensionPixelSize(R.dimen.textSize_52pt));
        textView.setSingleLine();
    ...
    public void initializeDefaultToolbar(String title, ToolbarMenu toolbarMenu){
        ...
        switch (toolbarMenu) {
            case LEFT:
                setTitleGravity(ToolbarGravity.LEFT);
