package com.pplus.prnumberbiz.core.sns.naver;
...
//    private static String OAUTH_CLIENT_NAME = "네이버 아이디로 로그인";
    ...
    public static void init(Context context, OAuthLoginButton oAuthLoginButton, NaverCallbackListener naverCallbackListener){
        ...
        mOAuthLoginModule.init(context, context.getString(R.string.naver_client_id), context.getString(R.string.naver_client_secret), context.getString(R.string.app_name));
    ...
    public static void click(Activity activity, NaverCallbackListener naverCallbackListener){
        ...
        mNaverCallbackListener = naverCallbackListener;
        mOAuthLoginModule = OAuthLogin.getInstance();
        mOAuthLoginModule.init(mContext, activity.getString(R.string.naver_client_id), activity.getString(R.string.naver_client_secret), mContext.getString(R.string.app_name));
