...
public class StartPointSeekBar extends View {
    ...
    public StartPointSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (thumbImageDrawable == null) {
            thumbImageDrawable =  AppCompatResources.getDrawable(context, R.drawable.ic_write_edit_pointer);
        }
        ...
        if (thumbImagePressedDrawable == null) {
            thumbImagePressedDrawable =  AppCompatResources.getDrawable(context, R.drawable.ic_write_edit_pointer);
        }
