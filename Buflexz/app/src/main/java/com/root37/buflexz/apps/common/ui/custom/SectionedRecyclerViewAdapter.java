...
public abstract class SectionedRecyclerViewAdapter<VH extends RecyclerView.ViewHolder , V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public abstract void onBindViewHolder(V holder, int section, int relativePosition, int absolutePosition);
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (isHeader(position)) {
            ...
            final int[] sectionAndPos = getSectionIndexAndRelativePosition(position);
            final int absPos = position - (sectionAndPos[0] + 1);
            onBindViewHolder((V)holder, sectionAndPos[0],
                    // offset section view positions
