...
import com.root37.buflexz.apps.lottery.data.LotteryWinHeaderAdapter
...
import com.root37.buflexz.databinding.ActivityLotteryResultBinding
        ...
        ApiBuilder.create().getLotteryByLotteryRound(lotteryRound).setCallback(object : PplusCallback<NewResultResponse<Lottery>> {
            override fun onResponse(call: Call<NewResultResponse<Lottery>>?, response: NewResultResponse<Lottery>?) {
                ...
                if (response?.result != null) {
                    ...
                    plusText.setTextColor(ResourceUtil.getColor(this@LotteryResultActivity, R.color.white))
