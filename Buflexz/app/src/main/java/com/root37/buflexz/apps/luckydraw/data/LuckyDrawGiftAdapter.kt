...
import com.root37.buflexz.databinding.ItemLuckyDrawGiftBinding
...
class LuckyDrawGiftAdapter() : RecyclerView.Adapter<LuckyDrawGiftAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when(item.type){//goods, coin, giftCard, ball, point, buffCoin
            "goods", "coin", "giftCard"->{
                holder.binding.textLuckyDrawGiftPrice.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_lucky_draw_gift_dollar, 0, 0, 0)
            }
            "ball"->{
                holder.binding.textLuckyDrawGiftPrice.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_lucky_draw_gift_ball, 0, 0, 0)
            }
            "point"->{
                holder.binding.textLuckyDrawGiftPrice.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_lucky_draw_gift_point, 0, 0, 0)
            }
            "buffCoin"->{
                holder.binding.textLuckyDrawGiftPrice.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_lucky_draw_gift_buff, 0, 0, 0)
            }
        }
