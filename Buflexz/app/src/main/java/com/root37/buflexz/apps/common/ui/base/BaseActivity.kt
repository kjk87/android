package com.root37.buflexz.apps.common.ui.base
...
import com.root37.buflexz.apps.common.toolbar.ToolbarOption.ToolbarGravity
import com.root37.buflexz.apps.common.toolbar.ToolbarOption.ToolbarMenu
import com.root37.buflexz.core.util.PplusCommonUtil
import com.root37.buflexz.databinding.ActivityBaseBinding
import com.root37.buflexz.databinding.ToolbarBinding
...
//        }
    ...
    private fun initializeToolbar() {
        ...
        if (toolbarOption != null) {
            ...
            setActionbarColor(ResourceUtil.getColor(this, R.color.color_1b1b1b))
        }
        val v = getLayoutView()
