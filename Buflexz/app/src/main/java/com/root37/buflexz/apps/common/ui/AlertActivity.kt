...
import com.root37.buflexz.apps.common.builder.data.AlertData.MessageData
import com.root37.buflexz.apps.common.component.autofit.AutofitTextView
import com.root37.buflexz.apps.common.ui.base.BaseActivity
import com.root37.buflexz.core.util.PplusCommonUtil
import com.root37.buflexz.databinding.ActivityAlertBinding
import com.root37.buflexz.databinding.ItemAlertTextLayoutBinding
...
class AlertActivity : BaseActivity(), View.OnClickListener {
    ...
    @ColorRes
    private val alertMessageColor = R.color.white
    ...
    override fun initializeView(savedInstanceState: Bundle?) {
        ...
        if (alertResult!!.alertData != null) {
            ...
            if (StringUtils.isEmpty(alertResult!!.alertData!!.title)) {
                ...
                binding.textAlertTitle.setTextColor(ResourceUtil.getColor(this, R.color.white))
            ...
            if (alertResult!!.alertData!!.style_alert == STYLE_ALERT.MESSAGE) {
                ...
                for (i in alertResult!!.alertData!!.contents.indices) {
                    ...
                    radioButton.setTextColor(ResourceUtil.getColor(this@AlertActivity, R.color.white))
