package com.root37.buflexz.apps.inquire.data
...
import com.root37.buflexz.databinding.ItemInquireBinding
...
class InquireAdapter() : RecyclerView.Adapter<InquireAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when(item.status){
            "pending"->{
                holder.binding.textInquireStatus.setBackgroundResource(R.drawable.bg_1b1b1b_radius_10)
                holder.binding.textInquireStatus.setText(R.string.word_pending_reply)
                holder.binding.textInquireReply.visibility = View.GONE
            }
            "complete"->{
                holder.binding.textInquireStatus.setBackgroundResource(R.drawable.bg_2a764b_radius_10)
