package com.root37.buflexz.push
...
class NotiManager(private val context: Context) {
    ...
    companion object {
        private val CHANNEL_ID = "com.root37.buflexz.NOTI"
        private val CHANNEL_NAME = BuflexzApplication.context.getString(R.string.app_name)
        private val CHANNEL_DESCRIPTION = BuflexzApplication.context.getString(R.string.app_name)
    }
