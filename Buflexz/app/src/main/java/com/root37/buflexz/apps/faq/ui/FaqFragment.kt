...
import com.root37.buflexz.apps.faq.data.FaqAdapter
...
import com.root37.buflexz.databinding.FragmentFaqBinding
            ...
            override fun onResponse(call: Call<NewResultResponse<ListResultResponse<Faq>>>?, response: NewResultResponse<ListResultResponse<Faq>>?) {
                ...
                if (response?.result != null) {
                    if (page == 1) {
                        ...
                        binding.textFaqCount.text = getString(R.string.format_faq_count, FormatUtil.getMoneyType(mTotalCount.toString()))
                    }
