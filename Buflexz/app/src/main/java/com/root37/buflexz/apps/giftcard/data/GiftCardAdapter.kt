package com.root37.buflexz.apps.giftcard.data
...
import com.root37.buflexz.databinding.ItemGiftCardBinding
import com.root37.buflexz.databinding.ItemGiftCardBrandBinding
...
class GiftCardAdapter() : RecyclerView.Adapter<GiftCardAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.textGiftCardPrice.text = item.price.toString()
